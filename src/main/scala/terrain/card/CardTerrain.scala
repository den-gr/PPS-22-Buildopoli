...
object CardTerrain:
   ...
   * @param terrain instance of terrain where to put the card terrain
   * @return a new DefaultCardTerrain
   */
   ...
   * @param terrain instance of terrain where to put the card terrain
   * @param gameSession current instance of gameSession to use when defining event groups and consequences of each card
   * @param surprises boolean object, if true some surprise cards will be added, else some probability cards will be added
   * @return a new DefaultCardTerrain with some probability or surprise cards
   */
   ...
   * @param gameSession used to create consequences of each card
   * @return list of surprise cards
   */
   ...
   * @param gameSession used to create consequences of each card
   * @return list of probability cards
   */
